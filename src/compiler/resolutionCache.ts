 ...
 * @internal
 */
export type ResolutionCache = ReturnType<typeof createResolutionCache>;
...
/** @internal */
export function needsResolutionFromGlobalCache(moduleName: string, resolution: ResolvedModuleWithFailedLookupLocations) {
...
/** @internal */
export function isResolvedWithGlobalCachePass(resolution: ResolutionWithFailedLookupLocations): resolution is
    & ResolvedModuleWithFailedLookupLocations
    & { globalCacheResolution: ResolvedModuleFull | true; }
{
...
function resolveModuleNameUsingGlobalCache(
    ...
    primaryResult.globalCacheResolution = primaryResult.resolvedModule ?? true;
    if (resolvedModule) {
...
export function createResolutionCache(
    ...
    function getRootDirInfo(rootDirForResolution: string): RootDirInfo {
        ...
        return { rootDir, rootPath, rootPathComponents };
    }
    ...
    function finishCachingPerDirectoryResolution(newProgram: Program | undefined, oldProgram: Program | undefined, skipCacheCompact?: boolean) {
        allModuleAndTypeResolutionsAreInvalidated = false;
        resolutionsWithGlobalCachePassAreInvalidated = false;
        resolutionsWithoutGlobalCachePassAreInvalidated = false;
        unresolvedResolutionsWithGlobalCachePassAreInvalidated = false;
    ...
    function isInvalidatedUnResolvedGlobalCachePassResolution(resolution: ResolutionWithFailedLookupLocations) {
        return unresolvedResolutionsWithGlobalCachePassAreInvalidated &&
            ...
            isUnresolvedOrResolvedToJs(resolution as ResolvedModuleWithFailedLookupLocations);
    }
    ...
    function watchFailedLookupLocation(
        failedLookupLocation: string,
        { rootDir, rootPath, rootPathComponents }: RootDirInfo,
    ) {
