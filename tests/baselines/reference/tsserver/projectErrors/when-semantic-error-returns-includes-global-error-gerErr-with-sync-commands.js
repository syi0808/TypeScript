...
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /user/username/projects/myproject/ui.ts ProjectRootPath: undefined:: Result: /user/username/projects/myproject/tsconfig.json
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        ...
        "reason": "Creating possible configured project for /user/username/projects/myproject/ui.ts to open"
      }
    }
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /user/username/projects/myproject/ui.ts:: []
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        "triggerFile": "/user/username/projects/myproject/ui.ts",
...
/a/lib/lib.d.ts *new*
    ...
    containingProjects: 1
        /user/username/projects/myproject/tsconfig.json
/user/username/projects/myproject/ui.ts (Open) *new*
    version: SVC-1-0
    containingProjects: 1
