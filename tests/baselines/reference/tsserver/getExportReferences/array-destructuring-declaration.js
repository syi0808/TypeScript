...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /mod.ts:: []
...
Info seq  [hh:mm:ss:mss] Finding references to /mod.ts position 38 in project /tsconfig.json
Info seq  [hh:mm:ss:mss] response:
    {
      "response": {
        "refs": [
