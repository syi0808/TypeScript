...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /common/src/mymodule.ts:: []
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.legacy.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /common/tsconfig.json:: []
Info seq  [hh:mm:ss:mss] getUnresolvedImports:: Files:: 4 Done: []
Info seq  [hh:mm:ss:mss] Project '/common/tsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (4)
...
Info seq  [hh:mm:ss:mss] 	Files (6)
	...
	/common/src/MyModule.ts Text-1 "export function square(n: number) {\n  return n * 2;\n}"
	/web/src/MyApp.ts Text-1 "import { square } from \"@common/MyModule\";"
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.legacy.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /web/src/helper.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /common/src/mymodule.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /web/src/myapp.ts:: []
