...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/dep/src/index.ts:: []
              ...
              "textChanges": [
                {
                  ...
                  "newText": "import { dep } from \"dep/dist/sub/folder\";\r\n\r\n"
                }
              ]
            }
          ]
...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "arguments": {
        ...
        "endLine": 1,
        "endOffset": 1,
        "insertString": "import { dep } from \"dep/dist/sub/folder\";\r\n\r\n"
      },
      "command": "change"
    }
Info seq  [hh:mm:ss:mss] response:
