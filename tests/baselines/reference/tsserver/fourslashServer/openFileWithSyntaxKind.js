...
//// [/tests/cases/fourslash/server/dumbFile.ts]
var x;
...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "type": "request",
      "arguments": {
        "file": "/tests/cases/fourslash/server/dumbFile.ts"
      },
      "command": "open"
    }
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/dumbFile.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] 	Files (4)
	...
	/tests/cases/fourslash/server/dumbFile.ts SVC-1-0 "var x;"
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/dumbfile.ts:: []
...
Info seq  [hh:mm:ss:mss] 	FileName: /tests/cases/fourslash/server/dumbFile.ts ProjectRootPath: undefined
...
/lib.decorators.legacy.d.ts *new*
    ...
    containingProjects: 1
        /dev/null/inferredProject1*
/tests/cases/fourslash/server/dumbFile.ts (Open) *new*
    version: SVC-1-0
    containingProjects: 1
...
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/test.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] 	Files (4)
	...
	/lib.decorators.d.ts Text-1 lib.decorators.d.ts-Text
	/lib.decorators.legacy.d.ts Text-1 lib.decorators.legacy.d.ts-Text
	/tests/cases/fourslash/server/test.ts SVC-1-0 "/**\n * @type {number}\n */\nvar t;\nt."
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.legacy.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/test.ts:: []
Info seq  [hh:mm:ss:mss] getUnresolvedImports:: Files:: 4 Done: []
Info seq  [hh:mm:ss:mss] Project '/dev/null/inferredProject1*' (Inferred)
Info seq  [hh:mm:ss:mss] 	Files (4)
...
/lib.decorators.legacy.d.ts *changed*
    ...
    containingProjects: 2 *changed*
        /dev/null/inferredProject1*
        /dev/null/inferredProject2* *new*
/tests/cases/fourslash/server/dumbFile.ts (Open)
    version: SVC-1-0
    containingProjects: 1
        /dev/null/inferredProject1* *default*
/tests/cases/fourslash/server/test.ts (Open) *new*
    version: SVC-1-0
    containingProjects: 1
