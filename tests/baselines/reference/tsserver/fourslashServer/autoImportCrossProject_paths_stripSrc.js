...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/dep/src/sub/folder/index.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/dep/src/main.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/app/src/a.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/app/src/index.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/app/src/utils.ts:: []
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /lib.decorators.legacy.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/app/package.json:: []
              ...
              "textChanges": [
                {
                  ...
                  "newText": "import { dep2 } from \"dep/sub/folder\";\r\n\r\n"
                }
              ]
            }
          ]
...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "arguments": {
        ...
        "endLine": 1,
        "endOffset": 1,
        "insertString": "import { dep2 } from \"dep/sub/folder\";\r\n\r\n"
      },
      "command": "change"
    }
Info seq  [hh:mm:ss:mss] response:
