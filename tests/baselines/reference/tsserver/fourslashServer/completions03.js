...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "type": "request",
      "arguments": {
        "file": "/tests/cases/fourslash/server/completions03.ts"
      },
      "command": "open"
    }
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/completions03.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] 	Files (4)
	...
	/tests/cases/fourslash/server/completions03.ts SVC-1-0 "interface Foo {\n   one: any;\n   two: any;\n   three: any;\n}\n\nlet x: Foo = {\n    get one() { return \"\" },\n    set two(t) {},\n    \n}"
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/completions03.ts:: []
...
Info seq  [hh:mm:ss:mss] 	FileName: /tests/cases/fourslash/server/completions03.ts ProjectRootPath: undefined
