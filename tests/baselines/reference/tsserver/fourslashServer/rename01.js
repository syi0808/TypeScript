...
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/rename01.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/rename01.ts:: []
...
/lib.decorators.legacy.d.ts *new*
    ...
    containingProjects: 1
        /dev/null/inferredProject1*
/tests/cases/fourslash/server/rename01.ts (Open) *new*
    version: SVC-1-0
    containingProjects: 1
