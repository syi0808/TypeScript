...
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /originalFile.ts 500 undefined WatchType: Closed Script info
...
Info seq  [hh:mm:ss:mss] 	Files (8)
	...
	/originalFile.ts Text-1 "import { t2 } from \"./other2\";\nimport { t3 } from \"./other3\";\nexport const n = 10;\nexport const m = t3 + t2 + n;"
	...
	other3.ts
	  ...
	  Imported via "./other3" from file 'originalFile.ts'
	  Part of 'files' list in tsconfig.json
	target.ts
	  Part of 'files' list in tsconfig.json
	other2.ts
	  Imported via "./other2" from file 'originalFile.ts'
	  Part of 'files' list in tsconfig.json
	originalFile.ts
	  Part of 'files' list in tsconfig.json
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /other.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /other3.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /target.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /other2.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /originalfile.ts:: []
            ...
            "textChanges": [
              {
                ...
                "newText": "import { n } from \"./originalFile\";\n"
              },
              {
                "start": {
                  "line": 2,
