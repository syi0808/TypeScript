...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "type": "request",
      "arguments": {
        "file": "/tests/cases/fourslash/server/referencesToStringLiteralValue.ts"
      },
      "command": "open"
    }
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/referencesToStringLiteralValue.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/referencestostringliteralvalue.ts:: []
...
/lib.decorators.legacy.d.ts *new*
    ...
    containingProjects: 1
        /dev/null/inferredProject1*
/tests/cases/fourslash/server/referencesToStringLiteralValue.ts (Open) *new*
    version: SVC-1-0
    containingProjects: 1
