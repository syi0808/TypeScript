...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/utils/dist/index.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /packages/app/dist/index.d.ts:: []
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /script.ts:: []
...
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /script.ts ProjectRootPath: undefined:: Result: /tsconfig.json
Info seq  [hh:mm:ss:mss] Project '/tsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (6)
