...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "type": "request",
      "arguments": {
        "file": "/tests/cases/fourslash/server/formatBracketInSwitchCase.ts"
      },
      "command": "open"
    }
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/formatBracketInSwitchCase.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] 	Files (4)
	...
	/tests/cases/fourslash/server/formatBracketInSwitchCase.ts SVC-1-0 "switch (x) {\n    case[]:\n}"
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/formatbracketinswitchcase.ts:: []
...
Info seq  [hh:mm:ss:mss] 	FileName: /tests/cases/fourslash/server/formatBracketInSwitchCase.ts ProjectRootPath: undefined
