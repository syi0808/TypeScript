...
//// [/b.ts]
import type A from './a'; export default A;

//// [/c.ts]
import A from './b'; new A();
...
Info seq  [hh:mm:ss:mss] 	Files (4)
	...
	/a.ts Text-1 "export default class A {}"
	/b.ts Text-1 "import type A from './a'; export default A;"
	/c.ts SVC-1-0 "import A from './b'; new A();"
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /c.ts:: []
