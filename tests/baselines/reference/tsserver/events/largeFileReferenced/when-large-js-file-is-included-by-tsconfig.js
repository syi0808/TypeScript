...
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /user/username/projects/myproject/src/file.ts ProjectRootPath: undefined:: Result: /user/username/projects/myproject/tsconfig.json
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        ...
        "reason": "Creating possible configured project for /user/username/projects/myproject/src/file.ts to open"
      }
    }
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        "triggerFile": "/user/username/projects/myproject/src/file.ts",
        "configFile": "/user/username/projects/myproject/tsconfig.json",
        "diagnostics": [
          {
            "text": "Cannot write file '/user/username/projects/myproject/src/large.js' because it would overwrite input file.",
            "code": 5055,
            "category": "error"
          },
          {
